...
<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <header class="bg-yellow-100 shadow p-4 flex justify-between items-center">
        ...
        <nav class="flex gap-4">
            <a href="/admin/dashboard" class="font-bold text-gray-700">Dashboard</a>
            <a href="/admin/riwayat-transaksi" class="text-gray-600 hover:text-gray-800">Riwayat Transaksi</a>
        </nav>
