    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
      ...
      <div class="flex flex-col justify-between">
        ...
        <ul class="text-gray-300 text-base space-y-2 mb-6">
          <li><strong class="text-yellow-400">Warna:</strong> Biru Metalik</li>
          <li><strong class="text-yellow-400">Stok:</strong> Tersedia</li>
          <li><strong class="text-yellow-400">Kategori:</strong> Yamaha</li>
        </ul>

        <!-- Harga -->
        <div class="flex items-center gap-6 mb-8">
          <span class="text-3xl font-semibold text-yellow-500">Rp 40.000.000</span>
        </div>
