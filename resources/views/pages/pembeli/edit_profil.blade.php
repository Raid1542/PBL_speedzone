...
<body class="bg-gray-900 text-yellow-300 font-sans">
  ...
  <!-- Form Edit Profil -->
  <main class="max-w-2xl mx-auto py-10 px-6 bg-gray-800 rounded-lg shadow-lg mt-8">
    <form action="update_profil" method="POST" enctype="multipart/form-data" class="space-y-6">
      
      <!-- Nama -->
      <div>
        <label for="nama" class="block text-sm font-medium text-yellow-300">Nama Lengkap</label>
        <input type="text" id="nama" name="nama" value="Frima Rizky Lianda" class="mt-1 block w-full border-gray-600 bg-gray-700 text-white rounded-md shadow-sm focus:ring-yellow-400 focus:border-yellow-400">
      </div>
      ...
      <!-- Telepon -->
      <div>
        <label for="telepon" class="block text-sm font-medium text-yellow-300">Telepon</label>
      ...
      <!-- Alamat -->
      <div>
        <label for="alamat" class="block text-sm font-medium text-yellow-300">Alamat</label>
      ...
      <!-- Upload Foto Profil -->
      <div>
        <label for="foto_profil" class="block text-sm font-medium text-yellow-300">Foto Profil</label>
      ...
      <!-- Upload Foto KTP -->
      <div>
        <label for="foto_ktp" class="block text-sm font-medium text-yellow-300">Foto KTP</label>
